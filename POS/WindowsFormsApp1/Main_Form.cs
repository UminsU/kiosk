...
namespace WindowsFormsApp1
{
    public partial class Main_Form : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e) // 체크카드결제 버튼
        {
            ...
            {
                textBox_cash.Text = textBox_sumcash.Text;
                DialogResult dlr = MessageBox.Show("체크카드결제 하시겠습니까?", "체크카드 결제", MessageBoxButtons.YesNo);
                switch (dlr)
                {
                    case DialogResult.Yes:
                        listView_order.Items.Clear();
        ...
        private void button_Card_Click(object sender, EventArgs e)// 신용카드결제 버튼
        {
            int count = listView_order.Items.Count;
            if (count == 0)
            {
            ...
            {
                textBox_cash.Text = textBox_sumcash.Text;
                DialogResult dlr = MessageBox.Show("신용카드결제 하시겠습니까?", "신용카드 결제", MessageBoxButtons.YesNo);
                switch (dlr)
                {
                    case DialogResult.Yes:
                        listView_order.Items.Clear();
